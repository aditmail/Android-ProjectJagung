...
public class updateProfil extends AppCompatActivity {
    ...
    EditText editText_nama, editText_handphone, editText_surel, editText_jKelamin,  editText_provinsi, editText_alamat, editText_kabupaten, editText_kecamatan;
    ...
    private String urlUpdateProfil = Konfigurasi.URL_UPDATE_DATA_DIRI;

    private static final String TAG = updateProfil.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_updateProfil = (Button) findViewById(R.id.btnUpdateProfil);

        editText_nama = (EditText)findViewById(R.id.updateNama);
        editText_handphone = (EditText)findViewById(R.id.updateNoHP);
        editText_surel = (EditText)findViewById(R.id.updateEmail);
        editText_alamat = (EditText)findViewById(R.id.updateAlamat);
        editText_kabupaten = (EditText)findViewById(R.id.updateKabupaten);
        editText_kecamatan = (EditText)findViewById(R.id.updateKecamatan);
        editText_jKelamin = (EditText)findViewById(R.id.lihatKelamin);
        editText_provinsi = (EditText)findViewById(R.id.lihatProvinsi);
        ...
        spinner_Provinsi.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (spinner_Provinsi.getSelectedItem().equals("Banten")){
                    ...
                    Toast.makeText(updateProfil.this, "Harap Pilih Provinsi Tempat Anda Tinggal", Toast.LENGTH_SHORT).show();
        ...
        spinner_kabupatenBanten.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (spinner_kabupatenBanten.getSelectedItem().equals("Kabupaten Pandegelang")) {
                    ...
                    spinner_kabupatenPandegelang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    spinner_kabupatenLebak.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenTangerang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenSerang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaCilegon.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaSerang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaTangerang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaTangerangSelatan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    Toast.makeText(updateProfil.this, "Harap Pilih Kabupaten Tempat Anda Tinggal", Toast.LENGTH_SHORT).show();
        ...
        spinner_kabupatenJawaBarat.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (spinner_kabupatenJawaBarat.getSelectedItem().equals("Kabupaten Bandung")) {
                    ...
                    spinner_kabupatenBandung.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenBandungBarat.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenBekasi.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenBogor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenCiamis.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenCianjur.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenCirebon.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenGarut.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenIndramayu.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenKarawang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenKuningan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenMajalengka.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenPangandaran.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenPurwakarta.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenSubang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenSukabumi.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenSumedang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenTasikmalaya.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaBandung.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaBanjar.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaBekasi.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaBogor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaCimahi.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaCirebon.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaDepok.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaSukabumi.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaTasikmalaya.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
        ...
        spinner_kabupatenJawaTengah.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (spinner_kabupatenJawaTengah.getSelectedItem().equals("Kabupaten Banjarnegara")) {
                    ...
                    spinner_kabupatenBanjarnegara.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenBanyumas.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenBatang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenBlora.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenBoyolali.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenBrebes.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenCilacap.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenDemak.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenGrobogan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenJepara.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenKaranganyar.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenKebumen.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenKendal.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenKlaten.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenKudus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenMagelang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenPati.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenPekalongan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenPemalang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenPurbalingga.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenPurworejo.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenRembang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenSemarang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenSragen.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenSukoharjo.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenTegal.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenTemanggung.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenWonogiri.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenWonosobo.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaMagelang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaPekalongan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaSalatiga.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaSemarang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaSurakarta.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaTegal.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
        ...
        spinner_kabupatenLampung.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (spinner_kabupatenLampung.getSelectedItem().equals("Kabupaten Lampung Barat")) {
                    ...
                    spinner_kabupatenLampungBarat.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenLampungSelatan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenLampungTengah.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenLampungTimur.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenLampungUtara.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenMesuji.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenPesawaran.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenPesisirBarat.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenPringsewu.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenTanggamus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenTulangBawang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenTulangBawangBarat.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kabupatenWayKanan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaBandarLampung.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
                    ...
                    spinner_kotaMetro.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            int indeks2 = parent.getSelectedItemPosition();
                            Resources res = getResources();
        ...
        editText_nama.setEnabled(false);
        editText_handphone.setEnabled(false);
        editText_surel.setEnabled(false);
        editText_jKelamin.setEnabled(false);
        editText_provinsi.setEnabled(false);
        editText_alamat.setCursorVisible(false);
        editText_alamat.setFocusableInTouchMode(false);
        editText_kabupaten.setEnabled(false);
        editText_kecamatan.setEnabled(false);
        btn_updateProfil.setVisibility(View.GONE);
        spinner_Provinsi.setVisibility(View.GONE);
        ...
        btn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editText_nama.setCursorVisible(true);
                editText_handphone.setCursorVisible(true);
                editText_surel.setCursorVisible(true);
                editText_alamat.setCursorVisible(true);


                editText_alamat.setCursorVisible(true);
                editText_alamat.setFocusableInTouchMode(true);

                editText_jKelamin.setVisibility(View.GONE);
                editText_provinsi.setVisibility(View.GONE);
                editText_kabupaten.setVisibility(View.GONE);
                editText_kecamatan.setVisibility(View.GONE);

                spinner_Provinsi.setVisibility(View.VISIBLE);
                spinner_gender.setVisibility(View.VISIBLE);

                btn_updateProfil.setVisibility(View.VISIBLE);
                spinner_Provinsi.setVisibility(View.VISIBLE);
        ...
        btn_updateProfil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                final String nama = editText_nama.getText().toString();
                final String hp = editText_handphone.getText().toString();
                final String surel = editText_surel.getText().toString();
                final String gender = spinner_gender.getSelectedItem().toString();

                final String alamat = editText_alamat.getText().toString();
                final String provinsi = spinner_Provinsi.getSelectedItem().toString();
                final String kabupaten = editText_kabupaten.getText().toString();
                final String kecamatan = editText_kecamatan.getText().toString();
...
/*
                        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(updateProfil.this);
                        alertDialogBuilder.setMessage("Apakah Anda Yakin Memperbaharui Data Diri Anda?");
                        ...
                        alertDialogBuilder.setPositiveButton("Ya",
                                new DialogInterface.OnClickListener() {
                                    ...
                                    */
                                        updateDataDiri(nama, hp, surel, gender, alamat, provinsi, kabupaten, kecamatan);
                        Toast.makeText(updateProfil.this, "Data Berhasil Disimpan", Toast.LENGTH_SHORT).show();
                                    /*}
                                });
...
*/
                    ...
                    if (TextUtils.isEmpty(kabupaten)) {
                        editText_kabupaten.setError("Harap Masukkan Nama Kabupaten Tempat Anda");
                        editText_kabupaten.requestFocus();
                        return;

                    }
                    if (TextUtils.isEmpty(kecamatan)) {
                        editText_kecamatan.setError("Harap Masukkan Nama Kecamatan Tempat Anda");
                        editText_kecamatan.requestFocus();
                    }
    ...
    private void updateDataDiri(final String nama, final String hp, final String surel, final String gender, final String alamat, final String provinsi,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, urlUpdateProfil, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Konfigurasi.TAG_NAMA, nama);
                params.put(Konfigurasi.TAG_HP, hp);
                params.put(Konfigurasi.TAG_SUREL, surel);
                params.put(Konfigurasi.TAG_GENDER, gender);
                params.put(Konfigurasi.TAG_ALAMAT, alamat);
                params.put(Konfigurasi.TAG_PROVINSI, provinsi);
                params.put(Konfigurasi.TAG_KABUPATEN, kabupaten);
                params.put(Konfigurasi.TAG_KECAMATAN, kecamatan);
                params.put(Konfigurasi.TAG_KECAMATAN, kecamatan);
                params.put(Konfigurasi.TAG_ID, MainActivity.id_pelanggan);
    ...
    private void getDataProfil(){
        class GetDataProfil extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam(Konfigurasi.URL_TAMPIL_DATA_PROFIL, MainActivity.id_pelanggan);
                return s;
            }
        }
    ...
    private void showDataProfil(String json){
        try {
            ...
            String namaProfil = c.getString(Konfigurasi.TAG_NAMA);
            String hpProfil = c.getString(Konfigurasi.TAG_HP);
            String surelProfil = c.getString(Konfigurasi.TAG_SUREL);
            String kelamin = c.getString(Konfigurasi.TAG_GENDER);
            String alamatProfil = c.getString(Konfigurasi.TAG_ALAMAT);
            String provinsi = c.getString(Konfigurasi.TAG_PROVINSI);
            String kabupatenProfil = c.getString(Konfigurasi.TAG_KABUPATEN);
            String kecamatanProfil = c.getString(Konfigurasi.TAG_KECAMATAN);

            editText_nama.setText(namaProfil);
            editText_handphone.setText(hpProfil);
            editText_surel.setText(surelProfil);
            editText_jKelamin.setText(kelamin);
            editText_alamat.setText(alamatProfil);
            editText_provinsi.setText(provinsi);
            editText_kabupaten.setText(kabupatenProfil);
            editText_kecamatan.setText(kecamatanProfil);
